                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                ...
                                <button class="btn btn-primary btn-round ml-auto mt-5" data-toggle="modal"
                                    data-target="#modalCreate"> <i class="fa fa-plus"></i>
                                    Tambah Data
                                </button>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <form method="POST" action="/barang/store">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="input-group mb-3">
                            <div class="input-group-prepend"><span class="input-group-text">IDR</span>
                            </div>
